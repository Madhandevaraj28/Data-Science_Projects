...
if SELECT == "Home":
    ...
    col1.image(Image.open("C:\\Users\\Madhan\\Desktop\\Phonepe_image2.png"), width=300)
    with col1:
        st.subheader(
    ...
    with col2:
        st.video("C:\\Users\\Madhan\\Desktop\\upi.mp4")
...
if SELECT == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r"C:\\Users\\Madhan\\Downloads\\Statenames.csv")
            df2.State = df1
...
if SELECT == "About":
    col1, col2 = st.columns(2)
    with col1:
        st.video("C:\\Users\\Madhan\\Desktop\\pulse-video.mp4")
    with col2:
        st.image(Image.open("C:\\Users\\Madhan\\Desktop\\Phonepe_image2.png"), width=500)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open("C:\\Users\\Madhan\\Desktop\\about_phonepe.jpg"), width=400)
        with open("C:\\Users\\Madhan\\Desktop\\about_phonepe1.png", "rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT", data, file_name="annual report.pdf")
    with col2:
        st.image(Image.open("C:\\Users\\Madhan\\Desktop\\about_phonepe1.png"), width=600)
...
if SELECT == "Contact":
    ...
    Name = (f'{"Name :"}  {"Madhan"}')
    mail = (f'{"Mail :"}  {"madhandevaraj1999@gmail.com"}')
