...
icon = Image.open('C:\\Users\\Madhan\\Desktop\\Youtube_logo.png')
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Madhan",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by Madhan*!*"""})
