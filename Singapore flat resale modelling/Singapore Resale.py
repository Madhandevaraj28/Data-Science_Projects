...
df = pd.read_csv("C:\\Users\\Madhan\\Downloads\\final.csv")

class App:
    def model(self):
        # Setting Page Configuration
        st.set_page_config(page_title="Flat resale prediction | By Madhan", layout="wide")
        ...
        if selected == "Flat resale_Prediction":
            ...
            with col2:
                ...
                with open("C:\\Users\\Madhan\\Downloads\\S1_regression.pkl", 'rb') as f:
                    model = pickle.load(f)
        ...
        if selected == "Contact":
            ...
            with col2:
                ...
                social_media = {"GITHUB": "https://github.com/Madhandevaraj28/Data-Science_Projects"}
