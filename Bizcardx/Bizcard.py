...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='Bisma@2012', auth_plugin='mysql_native_password')
...
icon = Image.open("C:\\Users\\Madhan\\Desktop\\business card.jfif")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By Madhan",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *Madhan*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:\\Users\\Madhan\\Desktop\\business card.jfif"), width=500)
